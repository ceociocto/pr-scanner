...
/** GitHub.com provider implementation using Octokit */
export class GitHubComProvider implements GitHubProvider {
...
/** Map GitHub API pull request response to our domain type */
